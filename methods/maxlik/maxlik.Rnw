...
\begin{frame}
<<echo=F, fig=T, include=F, label=lik1>>=
ruler <- seq(-2,3,.01)
plot(dnorm(ruler, mean=.5)~ruler, type="l", xlab="y", ylab=expression(paste("p(y|",mu,")")), main="Normal PDF", col=2)
legend(x="topright", legend=expression(paste("if ",mu,"=0.5")), col=2, lty=1)
abline(v=0.5, lty=3)
points(x=0.5, y=dnorm(0.5, mean=.5), col=2, pch=19, cex=2)
@
<<echo=F, fig=T, include=F, label=lik2>>=
ruler <- seq(-2,3,.01)
plot(dnorm(ruler, mean=.5)~ruler, type="l", xlab="y", ylab=expression(paste("p(y|",mu,")")), main="Normal PDF", col=2)
lines(dnorm(ruler, mean=-.5)~ruler, col=4)
points(x=0.5, y=dnorm(0.5, mean=-.5), col=4, pch=19, cex=2)
legend(x="topright", legend=c(expression(paste("if ",mu,"=0.5")),expression(paste("if ",mu,"=-0.5"))), col=c(2,4), lty=c(1,1))
abline(v=0.5, lty=3)
points(x=0.5, y=dnorm(0.5, mean=.5), col=2, pch=19, cex=2)
@ 
\begin{figure}
...
<<echo=F, fig=T, include=F, label=lik3>>=
ruler <- seq(-2,3,.01)
plot(dnorm(ruler, mean=.5)~ruler, type="l", xlab="y", ylab=expression(paste("p(y|",mu,")")), main="Normal PDF", col=2)
lines(dnorm(ruler, mean=-.5)~ruler, col=4)
lines(dnorm(ruler, mean=2)~ruler, col=3)
points(x=0.5, y=dnorm(0.5, mean=-.5), col=4, pch=19, cex=2)
points(x=0.5, y=dnorm(0.5, mean=2), col=3, pch=19, cex=2)
legend(x="topright", legend=c(expression(paste("if ",mu,"=0.5")),expression(paste("if ",mu,"=-0.5")),expression(paste("if ",mu,"=2"))), col=c(2,4,3), lty=c(1,1,1))
abline(v=0.5, lty=3)
points(x=0.5, y=dnorm(0.5, mean=.5), col=2, pch=19, cex=2)
@ 

<<echo=F, fig=T, include=F, label=lik4>>=
lik <- function(mu){
  dnorm(.5,mean=mu)
}
mu <- seq(-2,3,.01)
plot(lik(mu)~mu, type="l", xlab=expression(mu), main="Likelihood Function", ylab=expression(paste("L(",mu,"|y)")))
points(x=c(0.5,-0.5,2), y=c(lik(0.5), lik(-.5), lik(2)), col=c(2,4,3),
pch=19, cex=2)
@ 
\begin{figure}
...
\pause
<<echo=F, include=F, fig=T, label=loglik>>=
lik <- function(mu){
  dnorm(.5,mean=mu)
}
mu <- seq(-2,3,.01)
plot(lik(mu)~mu, type="l", xlab=expression(mu), main="Likelihood Function", ylab=expression(paste("L(",mu,"|y)")))
points(x=0.5, y=lik(.5), col=2, pch=19, cex=2)
abline(v=.5, lty=3)
@ 
<<echo=F, include=F, fig=T, label=loglik2>>=
loglik <- function(mu){
  dnorm(.5,mean=mu, log=T)
}
plot(loglik(mu)~mu, type="l", xlab=expression(mu), main="Log-Likelihood Function", ylab=expression(paste("l(",mu,"|y)")))
points(x=0.5, y=loglik(.5), col=2, pch=19, cex=2)
abline(v=.5, lty=3)
@ 
...
<<echo=F, fig=T, include=F, label=normalpdf>>=
ruler <- seq(-2,2,.01)
plot(dnorm(ruler)~ruler, xlab="x", ylab="F(x)", main="PDF", type="l")
@ 
<<echo=F, fig=T, include=F, label=normalcdf>>=
plot(pnorm(ruler)~ruler, xlab="x", ylab = "F(x)", main="CDF", type="l")
@ 
\begin{figure}
\begin{center}
...
<<echo=F, fig=T, include=F, label=poispdf>>=
ruler <- seq(0,10,1)
plot(dpois(ruler,5)~ruler, xlab="x", ylab="f(x)", main="PMF", pch=19)
@ 
<<echo=F, fig=T, include=F, label=poiscdf>>=
a <- ruler
b <- ruler+1[-length(a)]
plot(ppois(a,5)~a, xlab="x", ylab = "F(x)", main="CDF", pch=19)
points(y=ppois(a,5), x=b)
segments(x0=a, x1=b, y0=ppois(a,5), y1=ppois(a,5))
@ 
\begin{figure}
\begin{center}
